...
class VolumeCalibration5 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            continue: false,
            volumeLevel: 68, // New low level ADJUST ACCORDING TO DESIRED STEP!
        ...
        if (this.state.decreaseCount < 1) {
            this.setState(prevState => ({
                ...
                this.audioContext.close().then(() => {
                    ...
                    this.setState({ redirect: "/VolumeCalibrationEnd" }); // Set redirect after volume update
                });
            });
        }
    }
...
export default VolumeCalibration5;
